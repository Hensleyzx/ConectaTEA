  ...
  return (
    <Screen>
      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        <View style={styles.brand}><Image source={require('../../assets/conectatea-mark.png')} style={styles.logo} /><Text style={styles.name}>Conecta<Text style={{ color: colors.cyan }}>TEA</Text></Text><Text style={styles.version}>Protótipo funcional V2</Text></View>
        ...
        <SectionCard style={styles.card}><Text style={styles.cardTitle}>O que esta V2 já faz localmente</Text><Bullet icon="checkmark-circle" text="Persiste dados no aparelho." /><Bullet icon="checkmark-circle" text="Registra humor, intensidade, contexto e necessidade." /><Bullet icon="checkmark-circle" text="Cria, edita, exclui e conclui atividades de rotina." /><Bullet icon="checkmark-circle" text="Toca seis sons ambientes incluídos no projeto." /><Bullet icon="checkmark-circle" text="Oferece respiração, grounding 5-4-3-2-1 e timer visual." /><Bullet icon="checkmark-circle" text="Lê cartões de comunicação em voz alta." /><Bullet icon="checkmark-circle" text="Faz o pedido de ajuda aparecer no painel do responsável no mesmo aparelho." /><Bullet icon="checkmark-circle" text="Gera relatórios a partir dos dados realmente registrados." /></SectionCard>
